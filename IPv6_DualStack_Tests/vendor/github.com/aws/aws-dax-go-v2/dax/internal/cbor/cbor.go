...
var ErrObjTooBig = &smithy.DeserializationError{Err: fmt.Errorf("cbor: object too big")}
var ErrNegLength = &smithy.DeserializationError{Err: fmt.Errorf("cbor: negative length")}
